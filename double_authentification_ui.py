...
"}")
        ...
        self.lE_totp.setGeometry(QtCore.QRect(150, 60, 141, 31))
...
"}")
        ...
        self.pb_envoyer = QtWidgets.QPushButton(parent=Double_Auth)
        self.pb_envoyer.setGeometry(QtCore.QRect(140, 160, 91, 31))
        self.pb_envoyer.setStyleSheet("QPushButton {\n"
"    background-color: #dfe6e9;\n"
...
"    color: #ffffff;\n"
"}")
        self.pb_envoyer.setObjectName("pb_envoyer")
        self.pushButton = QtWidgets.QPushButton(parent=Double_Auth)
        self.pushButton.setGeometry(QtCore.QRect(150, 230, 75, 31))
...
"}")
    ...
    def retranslateUi(self, Double_Auth):
        ...
        Double_Auth.setWindowTitle(_translate("Double_Auth", "Double_Auth"))
        self.label.setText(_translate("Double_Auth", "Code à usage \n"
" unique "))
        self.pb_envoyer.setText(_translate("Double_Auth", "Envoyer"))
        self.pushButton.setText(_translate("Double_Auth", "Retour"))
